...
MODE: IMMUTABLE
FINALIZED: 2026-01-10T09:16:04Z
...
[ref:tasks/task_TASK_0036.md|v:1|tags:guardrail,gate,automation|src:system] - Automate _LOOP_GATE.md regeneration (deterministic PASS/BLOCKED)

[ref:tasks/task_TASK_0035.md|v:1|tags:context,briefing,automation|src:system] - Generate a compact session Context Pack (_SESSION.md)

[ref:tasks/task_TASK_0031.md|v:1|tags:context,index,history|src:system] - History Index generator (files↔tasks↔reports↔archives)

[ref:tasks/task_TASK_0032.md|v:1|tags:guardrail,lint,audit|src:system] - Metadata + consistency lint (drift detection)

[ref:tasks/task_TASK_0034.md|v:1|tags:guardrail,ux,cockpit|src:system] - Cockpit guardrail transparency/UX improvements

[ref:tasks/task_TASK_0033.md|v:1|tags:docs,skeleton,baseline|src:system] - Clarify/promote gate+bootstrap in canonical skeleton docs
