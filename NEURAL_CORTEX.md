...
**WHERE WE WANT TO GO →**
[ref:milestone_01.json#GOALS|v:3|tags:milestone|src:doc]
...
5. **READ OPS:** Open [ref:docs/OPS_PROTOCOLS.md|v:1|tags:ops|src:doc]
   - Review finalization procedures
   - Understand task creation and reference management

6. **CONFIRM ENTRY:** Call `/api/confirm-bootstrap` to transition to ACTIVE state
   - Ensures deterministic loop start timing
   - Generates session pack and updates gate

7. **PROCEED:** Open ALT.md or start work on active task
